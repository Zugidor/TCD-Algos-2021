...
public class stopTime {
    ...
    protected static Map<String, List<stopTime>> generateHashMapOfStopTimes (String pathToStopTimesFile) throws IOException{
        ...
        Map<String, List<stopTime>> stopTimes = new HashMap<String, List<stopTime>>();
        ...
        while((currentLine = reader.readLine()) != null) {
            ...
            try {
                //We can try to declare the strings as LocalTime objects
                LocalTime testTheArrivalTime= LocalTime.parse(arrival_time, DateTimeFormatter.ofPattern("H:mm:ss"));
                LocalTime testTheDepartureTime= LocalTime.parse(departure_time, DateTimeFormatter.ofPattern("H:mm:ss"));
            }
     ...
     * @return: void.
     */
    protected static void findListOfTripsWithGivenArrivalTime (String inputArrivalTime, Map<String, List<stopTime>> Map) throws IOException{
